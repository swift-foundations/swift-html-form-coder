...
struct ErrorErgonomicsTest {
    ...
    func testWrongStrategyGuidance() throws {
        // Foundation.Data encoded with accumulate values
        let accumulateData = Foundation.Data("name=Test&tags=swift&tags=ios&tags=server".utf8)
    ...
    func testStrategyDetection() throws {
        ...
        let bracketsData = Foundation.Data("tags[0]=swift&tags[1]=ios".utf8)
        let accumulateData = Foundation.Data("tags=swift&tags=ios".utf8)
        let emptyBracketsData = Foundation.Data("tags[]=swift&tags[]=ios".utf8)
